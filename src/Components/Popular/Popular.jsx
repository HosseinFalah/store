        ...
        <>
            <div className="popular-item-main bg-primary bg-gradient d-flex align-items-center justify-content-center shadow rounded px-4">
                <div className="col-6">
                    ...
                    <Link to={"/product/8"}><button className="btn btn-warning btn-sm bg-warning bg-gradient">همین الان بخر</button></Link>
                </div>
                <div className="col-6">
            ...
            <div className="popular-item-second bg-info bg-gradient d-flex align-items-center justify-content-center shadow rounded px-4">
                <div className="col-6">
                    ...
                    <div className="mb-3">
                        <Link to={"/product/12"}><button className="btn btn-primary btn-sm">همین الان بخر</button></Link>
                    </div>
                </div>
                <div className="col-6">
            ...
            <div className="popular-item-third bg-warning bg-gradient d-flex align-items-center justify-content-center shadow rounded px-4">
                <div className="col-6">
                    ...
                    <div className="mb-3">
                        <Link to={"/product/29"}><button className="btn btn-primary btn-sm">همین الان بخر</button></Link>
                    </div>
                </div>
                <div className="col-6">
